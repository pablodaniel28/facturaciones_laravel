                        ...
                        <div class="mb-4">
                            <div class="flex">
                                ...
                                <select name="metodo" id="metodo"
                                    ...
                                    required>
                                    <option value="Efectivo" {{ $venta->metodo == 'Efectivo' ? 'selected' : '' }}>
                                        Efectivo</option>
                                    <option value="Qr" {{ $venta->metodo == 'Qr' ? 'selected' : '' }}>QR</option>
                                </select>
                            </div>
                        </div>
                        <div class="mb-4">
                    ...
                    <tbody id="searchTableBody" class="text-xs divide-y divide-slate-100 dark:divide-slate-700">
                        ...
                        @foreach ($detalleventas as $p)
                            <tr>
                                ...
                                <td class="p-2 whitespace-nowrap">
                                    <div class="text-center font-medium">{{ $p->descuento }}</div>
                                </td>
                                <td class="p-2 whitespace-nowrap">
                                    <div class="text-center font-medium">{{ $p->producto->precio }}</div>
                                </td>
                                <td class="p-2 whitespace-nowrap">
                                    <div class="text-center font-medium">{{ $p->cantidad }}</div>
                                </td>
                                <td class="p-2 whitespace-nowrap">
                                    <div class="text-center font-medium">{{ $p->monto }}</div>
                                </td>
