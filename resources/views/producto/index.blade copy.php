<x-app-layout>
    <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-900 flex flex-col sm:flex-row items-center">
        ...
        <div id="crud-modal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-lg max-h-full" style="left: 50%; transform: translateX(-50%);">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <!-- Modal body -->
                    <form action="{{ route('productos.store') }}" method="POST" enctype="multipart/form-data" class="p-4 md:p-5">
                        @csrf
                        ...
                        <button type="submit"
                            class="text-white inline-flex items-center bg-cyan-600 hover:bg-cyan-800 focus:ring-4 focus:outline-none focus:ring-cyan-300 font-medium rounded-lg text-sm px-4 py-1.5 text-center dark:bg-slate-600 dark:hover:bg-slate-500 dark:focus:ring-cyan-800">
                    ...
                    <div class="mt-2">
                        <form method="POST" action="" enctype="multipart/form-data"
                            ...
                            <input type="file" name="documento"
                                class="bg-cyan-500 hover:bg-cyan-700 dark:bg-slate-700 dark:hover:bg-slate-600 text-white dark:text-slate-200 font-semibold px-1.5 py-1 rounded-md text-xs sm:text-xs mb-4"
                                style="font-size: 12px;" />
                            <button type="submit"
                                class="bg-cyan-500 hover:bg-cyan-700 dark:bg-gray-700 dark:hover:bg-gray-600 text-white dark:text-gray-200 font-semibold px-1.5 py-1 rounded-md text-xs sm:text-xs ml-1">
                                <i class="fas fa-plus mr-1 "></i>Importar
                            </button>
                        </form>
                    </div>
            ...
            <table class="table-auto w-full">
                ...
                <tbody class="text-xs divide-y divide-slate-100 dark:divide-slate-700">
                    <tr>
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-left font-medium">{{ $p->precio }}</div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-left font-medium">{{ $p->cantidad }}</div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
